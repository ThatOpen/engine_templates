  ...
  return BUI.html`
    <bim-panel>
      <bim-panel-section fixed label="That Open People at your disposal" icon="ic:baseline-people">
        ...
        <bim-button @click=${() =>
          open(
            "https://people.thatopen.com/"
          )} label="Meet That Open People" icon="ic:baseline-people"></bim-button>
      </bim-panel-section>
      <bim-panel-section fixed label="Become a BIM Software Developer" icon="mdi:university">
        ...
        <bim-button @click=${() =>
          open(
            "https://thatopen.com/master"
          )} label="Join To Master" icon="mdi:university"></bim-button>
      </bim-panel-section>
      <bim-panel-section fixed label="Get The Code and Boost your Career" icon="material-symbols:code">
        ...
        <bim-button @click=${() =>
          open(
            "https://thatopen.com/get-the-code"
          )} label="Get The Code" icon="material-symbols:code"></bim-button>
      </bim-panel-section>
    </bim-panel>
  `;
});
